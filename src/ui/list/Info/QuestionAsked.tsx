...
function QuestionAsked({ children, header, MyBtn }: props) {
  return (
    <>
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-3 justify-between">
          <div className="flex items-center gap-3">
            <SVGHelpInfo
              width={32}
              height={32}
              className={`${amberTextBlack} ${amberTextWhite} ${amberFillWhite} ${amberFillBlack}   min-w-8`}
            />
        ...
        <div
          className={`border-l-4 ${amberBorderBlack} ${amberBorderWhite} pl-4 ml-[14px] text-base`}
        >
          {children}
        </div>
      </div>
