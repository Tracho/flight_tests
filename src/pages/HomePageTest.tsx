    ...
    <>
      <div className='flex justify-center'>
        <div className='container px-4 py-10'>
          ...
          <br />
          <Details arr={testArr} header='Test Header'></Details>
          <br />
          <br />
          
          <BgContainer className="flex flex-col gap-5">
            <Info header="Lorem ipsum dolor sit amet consectetur">
              <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Omnis, quia repellat voluptates iure tempora repellendus laborum molestias expedita error, autem beatae laudantium quaerat accusantium facilis minus ipsum adipisci voluptatibus placeat?</p>
            </Info>
